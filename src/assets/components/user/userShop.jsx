...
const UshopPage = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const resp = await axios.get("https://artistry-backend-ss49.onrender.com/products");
  ...
  useEffect(() => {
    const fetchMaterials = async () => {
      try {
        const resp = await axios.get("https://artistry-backend-ss49.onrender.com/materials");
